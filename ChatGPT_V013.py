...
# Funktion zum Speichern des Chatverlaufs
...
''' Macht keinen Sinn, da das Programm den geladenen Verlauf nicht lesen kann
# Funktion zum Laden eines Chatverlaufs
def load_chat_history():
    """Lädt einen gespeicherten Chatverlauf aus einer Datei."""
    ...
    if file_path:
        try:
            ...
            messagebox.showinfo("Erfolg", "Chatverlauf wurde erfolgreich geladen.")
        except Exception as e:
